                ...
                <div class="tab-pane fade show active" id="parq" role="tabpanel">
                        ...
                        <div class="card shadow-sm my-2">
                            <div class="card-header">
                                ...
                                <div class="card-toolbar">
                                    @if ($parq == null)
                                        <a href="{{ route('users.parqs.create', ['user' => $user->id]) }}"
                                            class="btn btn-primary btn-sm">{{ __('Create a new Par-q Test') }}</a>
                                    @else
                                        <a href="{{ route('users.parqs.edit', ['user' => $user->id, 'parq' => $parq->id]) }}"
                                            class="btn btn-primary btn-sm">{{ __('Update Par-q Test') }}</a>
                                    @endif
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive align-middle text-center">
                                    <table class="table table-bordered">
                                        @if (isset($parq))
                                            ...
                                            <tbody>
                                                <td>{{ __('Have you ever had a cardiovascular (heart disease, vascular disease etc.) condition before?') }}
                                                </td>
                                                <td>{{ $parq->cardiovascular }}</td>
                                            </tbody>
                                            <tbody>
                                                <td>{{ __('Have you felt pain in your chest while walking or climbing stairs in the past month?') }}
                                                </td>
                                                <td>{{ $parq->chest_pain }}</td>
                                            </tbody>
                                            <tbody>
                                                <td>{{ __('Have you ever had a spinal cord (hernia, slipped disc, scoliosis etc.) disorder?') }}
                                                </td>
                                                <td>{{ $parq->spinal_cord_discomfort }}</td>
                                            </tbody>
                                            <tbody>
                                                <td>{{ __('Have you ever had an anatomical disorder (fracture,fiber breakage etc.) before?') }}
                                                </td>
                                                <td>{{ $parq->anatomical_discomfort }}</td>
                                            </tbody>
                                            <tbody>
                                                <td>{{ __('Have you ever had a surgical intervention (surgery etc.) before?') }}
                                                </td>
                                            ...
                                            <tbody>
                                                <td>{{ __('Do you have a supplement (vitamins, protein powders etc.) that you use regularly?') }}
                                                </td>
                                            ...
                                            <tbody>
                                                <td>{{ __('Do you have an addiction to drugs, alcohol etc.? If yes, have you had any treatment related to them?') }}
                                                </td>
                    ...
                    <div class="card shadow-sm my-2">
                        <div class="card-header">
                            ...
                            <div class="card-toolbar">
                                @if ($general != null)
                                    <a href="{{ route('users.generals.index', ['user' => $user->id]) }}"
                                        class="btn btn-primary btn-sm"><span class="svg-icon svg-icon-1">
                                            {{ __('See All') }}
                                    </a>
                                @else
                                    <a href="{{ route('users.generals.create', ['user' => $user->id]) }}"
                                        class="btn btn-primary btn-sm"><span class="svg-icon svg-icon-1">
                                ...
                                <div class="table-responsive px-4">
                                    <table class="table table-bordered align-middle text-center">
                                        ...
                                        <tbody>
                                            ...
                                            <td>
                                                @if ($general != null)
                                                    {{ $general->physical_performance_score }}
                                                @endif
                                            </td>
                                        </tbody>
                                    </table>
                ...
                <div class="tab-pane fade" id="bodyfats" role="tabpanel">
                    ...
                    <div class="card shadow-sm my-2">
                        <div class="card-header">
                            ...
                            <div class="card-toolbar">
                                <a href="{{ route('users.bodyfats.index', ['user' => $user->id]) }}"
                                    ...
                                    <span class="svg-icon svg-icon-1">
                                        <svg width="10" height="10" viewBox="0 0 24 24" fill="none"
                                            ...
                                            <rect x="11" y="9" width="2" height="2"
                                                rx="1" transform="rotate(-90 11 9)" fill="currentColor" />
                                        </svg>
                                    </span>{{ __('See All') }}
                                </a>
                            </div>
                ...
                <div class="tab-pane fade" id="bloodpressures" role="tabpanel">
                    ...
                    <div class="card shadow-sm my-2">
                        <div class="card-header">
                            ...
                            <div class="card-toolbar">
                                <a href="{{ route('users.bloodpressures.index', ['user' => $user->id]) }}"
                                    class="btn btn-primary btn-sm">
                                    <span class="svg-icon svg-icon-1">
                                        <svg width="10" height="10" viewBox="0 0 24 24" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="tab-pane fade" id="bloodsugars" role="tabpanel">
                    ...
                    <div class="card shadow-sm my-2">
                        <div class="card-header">
                            ...
                            <div class="card-toolbar">
                                <a href="{{ route('users.fastingbloodsugars.index', ['user' => $user->id]) }}"
                                    class="btn btn-primary btn-sm">
                                    <span class="svg-icon svg-icon-1">
                                        <svg width="10" height="10" viewBox="0 0 24 24" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="tab-pane fade" id="lungcapacities" role="tabpanel">
                    ...
                    <div class="card shadow-sm my-2">
                        <div class="card-header">
                            ...
                            <div class="card-toolbar">
                                <a href="{{ route('users.lungcapacities.index', ['user' => $user->id]) }}"
                                    class="btn btn-primary btn-sm">
                                    <span class="svg-icon svg-icon-1">
                                        <svg width="10" height="10" viewBox="0 0 24 24" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="tab-pane fade" id="mobility" role="tabpanel">
                    ...
                    <div class="card my-4">
                        <div class="card-header">
                            ...
                            <div class="card-toolbar">
                                <a href="{{ route('users.mobilities.index', ['user' => $user->id]) }}"
                                    class="btn btn-primary btn-sm">
                                    <span class="svg-icon svg-icon-1">
                                        <svg width="10" height="10" viewBox="0 0 24 24" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="tab-pane fade" id="strength" role="tabpanel">
                    ...
                    <div class="card my-4">
                        <div class="card-header">
                            ...
                            <div class="card-toolbar">
                                <a href="{{ route('users.strengths.index', ['user' => $user->id]) }}"
                                    class="btn btn-primary btn-sm">
                                    <span class="svg-icon svg-icon-1">
                                        <svg width="10" height="10" viewBox="0 0 24 24" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="tab-pane fade" id="maxvo2" role="tabpanel">
                    ...
                    <div class="card shadow-sm my-2">
                        <div class="card-header">
                            ...
                            <div class="card-toolbar">
                                <a href="{{ route('users.maxvo2s.index', ['user' => $user->id]) }}"
                                    class="btn btn-primary btn-sm">
                                    <span class="svg-icon svg-icon-1">
                                        <svg width="10" height="10" viewBox="0 0 24 24" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="tab-pane fade" id="flexibility" role="tabpanel">
                    ...
                    <div class="card shadow-sm my-2">
                        <div class="card-header">
                            ...
                            <div class="card-toolbar">
                                <a href="{{ route('users.flexibilities.index', ['user' => $user->id]) }}"
                                    class="btn btn-primary btn-sm">
                                    <span class="svg-icon svg-icon-1">
                                        <svg width="10" height="10" viewBox="0 0 24 24" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
