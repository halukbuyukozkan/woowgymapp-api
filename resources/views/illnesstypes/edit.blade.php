...
@section('content')
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="toolbar" id="kt_toolbar">
            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                    ...
                    <!--begin::Title-->
                    <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">{{ __('Illness Type') }}
                        <!--begin::Separator-->
        ...
        <div class="container">
            <div class="row mb-3">
                <div class="col-md-3">
                    <h2>{{ __('Edit Illness Type') }}</h2>
                </div>
            </div>
            <div class="card">
                <form action="{{ route('illnessTypes.update', $illnessType) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="p-4">
                        <div>
