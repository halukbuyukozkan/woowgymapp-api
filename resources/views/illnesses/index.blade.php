        ...
        <div class="toolbar" id="kt_toolbar">
            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                    ...
                    <!--begin::Title-->
                    <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">{{ __('Illnesses') }}
                        <!--begin::Separator-->
                                ...
                                @foreach ($illnesses as $illness)
                                    <tbody>
                                        ...
                                        <td class="align-middle">
                                            <div class="btn-group">
                                                <a href="{{ route('illnesses.edit', $illness) }}"
                                                    class="btn btn-primary btn-sm py-2 px-4">{{ __('Edit') }}</a>
                                                <form action="{{ route('illnesses.destroy', $illness) }}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit"
