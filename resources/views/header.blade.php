            ...
            <div class="d-flex align-items-stretch flex-shrink-0">
                ...
                <div class="d-flex align-items-stretch flex-shrink-0">
                    ...
                    <div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                        ...
                        <div class="mx-2">
                            <a href="{{ route('changeLocal', ['locale' => 'en']) }}"
                                class="btn btn-light-primary {{ app()->getLocale() == 'en' ? 'active' : '' }} p-2">EN</a>
                            <a href="{{ route('changeLocal', ['locale' => 'tr']) }}"
                                class="btn btn-light-primary {{ app()->getLocale() == 'tr' ? 'active' : '' }} p-2">TR</a>
                        </div>
                        <!-- LANGUAGE SWITCH END -->
                            ...
                            <div class="menu-item px-3">
                                <div class="menu-content d-flex align-items-center px-3">
                                    ...
                                    <div class="d-flex flex-column">
                                        <div class="fw-bolder d-flex align-items-center fs-5">{{ __('test') }}
                                        </div>
                                        <a href="#"
                                            class="fw-bold text-muted text-hover-primary fs-7">{{ __('test') }}</a>
                                    </div>
                                    <!--end::Username-->
                                </div>
                            </div>
