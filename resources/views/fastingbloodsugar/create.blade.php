...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
    ...
    <div class="container">
        <div class="row mb-3">
            <div class="col-md-3">
                <h2>New Fasting Blood Sugar Entry:</h2>
            </div>
        </div>
        <div class="card">
            <form action="{{ route('users.fastingbloodsugars.store',$user->id) }}" method="POST">
                @csrf
                <div class="p-4">
                    <div class="mb-3">
                    ...
                    <button type="submit" class="btn btn-primary">Create Fasting Bloodsugar</button>
                </div>
            </form>
        </div>
    </div>
