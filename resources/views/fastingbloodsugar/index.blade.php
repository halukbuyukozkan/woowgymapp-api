...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
    ...
    <div class="container">
        <div class="row mb-3">
            <div class="col-md-3">
                <h2>{{ __('user_fastingbloodsugar', ['name' => $user['name']]) }}</h2>
            </div>
            <div class="col-md-9 d-flex justify-content-end pr-4">
                <a href="{{route('users.fastingbloodsugars.create',['user' => $user->id])}}" class="btn btn-primary">{{__('Create a New Fasting Blood Sugar Entry')}}</a>
            </div>
            <div class="card my-2">
