    ...
    <div class="container">
        ...
        <div class="card">
            <form action="{{ route('users.parqs.store',$user->id) }}" method="POST">
                ...
                <div class="p-4">
                    <div class="mb-3">
                        <label for="chronic_illness" class="form-label">Do you have a chronic illness?</label>
                        <input type="text" class="form-control" id="chronic_illness" name="chronic_illness" required>
                    </div>
                    <div class="mb-3">
                        <label for="tension" class="form-label">Have you ever had a blood pressure problem before?</label>
                        <input type="text" class="form-control" id="tension" name="tension" required>
                    </div>
                    <div class="mb-3">
                        <label for="cardiovascular" class="form-label">Have you ever had a cardiovascular (heart disease, vascular disease etc.) condition before?</label>
                    ...
                    <div class="mb-3">
                        <label for="spinal_cord_discomfort" class="form-label">Have you ever had a spinal cord (hernia, slipped disc, scoliosis etc.) disorder?</label>
                        <input type="text" class="form-control" id="spinal_cord_discomfort" name="spinal_cord_discomfort" required>
                    </div>
                    <div class="mb-3">
                        <label for="anatomical_discomfort" class="form-label">Have you ever had an anatomical disorder (fracture,fiber breakage etc.) before?</label>
                        <input type="text" class="form-control" id="anatomical_discomfort" name="anatomical_discomfort" required>
                    </div>
                    <div class="mb-3">
                        <label for="operation" class="form-label">Have you ever had a surgical intervention (surgery etc.) before?</label>
                        <input type="text" class="form-control" id="operation" name="operation" required>
                    </div>
                    <div class="mb-3">
                        <label for="diabetes" class="form-label">Do you have type 1 or type 2 diabetes?</label>
                        <input type="text" class="form-control" id="diabetes" name="diabetes" required>
                    </div>
                    <div class="mb-3">
                        <label for="medicine" class="form-label">Do you have a medication that you use regularly?</label>
                        <input type="text" class="form-control" id="medicine" name="medicine" required>
                    </div>
                    <div class="mb-3">
                        <label for="supplements" class="form-label">Do you have a supplement (vitamins, protein powders etc.) that you use regularly?</label>
                    ...
                    <div class="mb-3">
                        <label for="addiction" class="form-label">Do you have an addiction to drugs, alcohol etc.? If yes, have you had any treatment related to them?</label>
                        <input type="text" class="form-control" id="addiction" name="addiction" required>
                    </div>
                    <div class="mb-3">
                        <label for="allergy" class="form-label">Do you have any food sensitivities or allergies?</label>
                        <input type="text" class="form-control" id="allergy" name="allergy" required>
                    </div>
                    <button type="submit" class="btn btn-primary">Create Par-q</button>
                </div>
            </form>
        </div>
    </div>
